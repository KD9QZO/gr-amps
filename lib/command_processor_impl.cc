...
command_processor::sptr command_processor::make() {
	return (gnuradio::get_initial_sptr(new command_processor_impl()));
}

/*
 * The private constructor
 */
command_processor_impl::command_processor_impl(): bch(63, 2, true), gr::block("command_processor", gr::io_signature::make(0, 0, 0), gr::io_signature::make(0, 0, 0)) {
	message_port_register_in(pmt::mp("commands"));
	set_msg_handler(pmt::mp("commands"), boost::bind(&command_processor_impl::commands_message, this, _1));
...
void command_processor_impl::forecast(int noutput_items, gr_vector_int &ninput_items_required) {
	/* <+forecast+> e.g. ninput_items_required[0] = noutput_items */
}

int command_processor_impl::general_work(int noutput_items, gr_vector_int &ninput_items, gr_vector_const_void_star &input_items, gr_vector_void_star &output_items) {
